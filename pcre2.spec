...
Source0  : https://github.com/PCRE2Project/pcre2/releases/download/pcre2-10.44/pcre2-10.44.tar.gz
Source1  : https://github.com/PCRE2Project/pcre2/releases/download/pcre2-10.44/pcre2-10.44.tar.gz.sig
Source2  : 9766E084FB0F43D8.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 9766E084FB0F43D8' gpg.status
%setup -q -n pcre2-10.44
cd %{_builddir}/pcre2-10.44
pushd ..
cp -a pcre2-10.44 build32
popd
pushd ..
cp -a pcre2-10.44 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720122964
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpcre2-16.so.0.13.0
/V3/usr/lib64/libpcre2-32.so.0.13.0
/V3/usr/lib64/libpcre2-8.so.0.13.0
/V3/usr/lib64/libpcre2-posix.so.3.0.5
/usr/lib64/libpcre2-16.so.0
/usr/lib64/libpcre2-16.so.0.13.0
/usr/lib64/libpcre2-32.so.0
/usr/lib64/libpcre2-32.so.0.13.0
