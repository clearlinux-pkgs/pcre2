...
Source0  : https://github.com/PCRE2Project/pcre2/releases/download/pcre2-10.43/pcre2-10.43.tar.gz
Source1  : https://github.com/PCRE2Project/pcre2/releases/download/pcre2-10.43/pcre2-10.43.tar.gz.sig
...
%prep
%setup -q -n pcre2-10.43
cd %{_builddir}/pcre2-10.43
pushd ..
cp -a pcre2-10.43 build32
popd
pushd ..
cp -a pcre2-10.43 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708464768
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpcre2-16.so.0.12.0
/V3/usr/lib64/libpcre2-32.so.0.12.0
/V3/usr/lib64/libpcre2-8.so.0.12.0
/V3/usr/lib64/libpcre2-posix.so.3.0.5
/usr/lib64/libpcre2-16.so.0
/usr/lib64/libpcre2-16.so.0.12.0
/usr/lib64/libpcre2-32.so.0
/usr/lib64/libpcre2-32.so.0.12.0
/usr/lib64/libpcre2-8.so.0
/usr/lib64/libpcre2-8.so.0.12.0
/usr/lib64/libpcre2-posix.so.3
/usr/lib64/libpcre2-posix.so.3.0.5

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libpcre2-16.so.0
/usr/lib32/libpcre2-16.so.0.12.0
/usr/lib32/libpcre2-32.so.0
/usr/lib32/libpcre2-32.so.0.12.0
/usr/lib32/libpcre2-8.so.0
/usr/lib32/libpcre2-8.so.0.12.0
